        ...
        <body style="background-color: #1F41A9;">
              <div class="background">
               ...
               <div class="container ">
                   ...
                   <div class="col wordimg hover" style="width: 50%; height: 400px; background-image: url(./img/bot.png);  background-repeat: no-repeat; background-size: contain;">

                   </div>

                   <div class="col wordimg hover" style="width: 50%; height: 400px; background-image: url(./img/shoe.png);  background-repeat: no-repeat; background-size: contain;">
                   </div>
